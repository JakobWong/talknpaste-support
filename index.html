    ...
    <section id="features" class="section">
      ...
      <div class="features-grid">
        <div class="feature">
          ...
          <p class="feature-description">Powered by cutting-edge AI technology with multiple model options for the perfect balance of speed and accuracy.</p>
        </div>
        
        <div class="feature">
          <div class="feature-icon">📋</div>
          <h3 class="feature-title">Instant Clipboard Integration</h3>
          <p class="feature-description">Text is automatically copied to your clipboard the moment transcription completes. No extra steps required.</p>
        </div>
        
        <div class="feature">
          <div class="feature-icon">⚡</div>
          <h3 class="feature-title">Menu Bar Convenience</h3>
          <p class="feature-description">Always accessible from your menu bar with a clean, minimal interface that stays out of your way.</p>
        </div>
        
        <div class="feature">
          <div class="feature-icon">🔐</div>
          <h3 class="feature-title">Privacy First</h3>
          <p class="feature-description">All processing happens locally on your Mac. Your voice data never leaves your device.</p>
        </div>
        
        <div class="feature">
          <div class="feature-icon">⌨️</div>
          <h3 class="feature-title">Keyboard Shortcuts</h3>
          <p class="feature-description">Quick access with customizable keyboard shortcuts: ⌘+Shift+R to start, ⌘+Shift+S to stop.</p>
        </div>
        
        <div class="feature">
          <div class="feature-icon">🌐</div>
          <h3 class="feature-title">Works Offline</h3>
          <p class="feature-description">No internet connection required. Perfect for private environments or when you're on the go.</p>
        </div>
      </div>
    </section>
    ...
    <div class="requirements">
      ...
      <div class="requirements-grid">
        <div class="requirement">
          ...
          <div class="requirement-value">12.0 or later</div>
        </div>
        <div class="requirement">
          <div class="requirement-label">Architecture</div>
          <div class="requirement-value">Apple Silicon or Intel</div>
        </div>
        <div class="requirement">
          <div class="requirement-label">Microphone</div>
          <div class="requirement-value">Required</div>
        </div>
        <div class="requirement">
